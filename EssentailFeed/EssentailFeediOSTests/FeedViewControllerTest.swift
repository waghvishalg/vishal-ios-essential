...
final class FeedViewControllerTest: XCTestCase {
    ...
    func test_feedView_hasTitle() {
        ...
        XCTAssertNotEqual(localizedKey, localizedTitle, "Missing localize string for key: \(localizedKey)")
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator for first view once first image loading successfully")
    ...
    func test_feedImageViewRetryButton_isVisibleOnImageURLLoadError() {
        ...
        XCTAssertEqual(view1?.isShowingRetryAction, true, "Expected no retry action for second view once second image loading completes with error")
    }
    ...
    func test_feedImageView_doesNotRenderLoadedImageWhenNotVisibleAnymore() {
        ...
        XCTAssertNil(view?.renderedImage, "Expected no rendered image when an image load finisher after the view is not visible anymore")
    }
